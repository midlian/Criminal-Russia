...
// #include "../VoiceNotificationPool.h"
...
public:
	...
	NotificationPool* GetNotificationPool() { return m_pNotificationPool; }
	// VoiceNotificationPool* GetVoiceNotificationPool() { return m_pVoiceNotificationPool; }
	...
	// void ResetVoiceNotificationPool();
	...
	void SendHash(const char* sHash);
...
private:
	...
	NotificationPool* 	m_pNotificationPool;
	// VoiceNotificationPool* m_pVoiceNotificationPool;
	int					m_iGameState;
