...
struct sWidgets
{
	WIDGET_TYPE* Attack = nullptr;
	WIDGET_TYPE* Sprint = nullptr;
	WIDGET_TYPE* Accelerate = nullptr;
	WIDGET_TYPE* EnterCar = nullptr;
	WIDGET_TYPE* CrossHair = nullptr;
	WIDGET_TYPE* Shoot = nullptr;
	WIDGET_TYPE* LeftShoot = nullptr;
};
